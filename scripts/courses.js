...
cseButton.addEventListener('click', handleCourseFilter);
...
function handleCourseFilter(e) {
    ...
    let sum = credits.reduce((total, credit) => total + credit, 0);
    output.appendChild(document.createElement('p')).textContent = `Total Credits: ${sum}`;
